      ...
      <section className="max-w-7xl mx-auto px-6 pb-24 grid lg:grid-cols-2 gap-12">
        ...
        <Reveal delay={0.1}>
          <form
            ...
            className="p-8 rounded-xl bg-surface border border-border space-y-5"
          >
            <h3 className="text-2xl font-display font-bold">Send an enquiry</h3>
            <div className="flex gap-4 text-sm">
              <label className="flex items-center gap-2"><input type="radio" name="type" defaultChecked className="accent-electric" /> Account Enquiry</label>
              <label className="flex items-center gap-2"><input type="radio" name="type" className="accent-electric" /> Tender Enquiry</label>
            </div>
            <Field label="Full name" name="name" />
            <Field label="Email" name="email" type="email" />
            <Field label="Enquiry" name="msg" textarea />
            <button type="submit" className="w-full px-5 py-3 rounded-md bg-electric text-background font-semibold hover:shadow-glow transition">
